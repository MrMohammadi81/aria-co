        ...
        <div class="main-menu default-transition">
            <div class="scroll ps ps--active-y">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="users/show">
                            <i class="iconsminds-digital-drawing"></i> کاربران
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e($config); ?>/users/10/update">
                            <i class="iconsminds-air-balloon-1"></i> ویرایش
                        </a>
                    </li>
                    <li>
                        <a href="#ui">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\FrameWork\App\Views/menu.blade.php ENDPATH**/ ?>